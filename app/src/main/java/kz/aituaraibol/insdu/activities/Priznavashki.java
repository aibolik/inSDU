...
public class Priznavashki extends ActionBarActivity {
    ...
    class PostsRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Priznavashki.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            params.add(new BasicNameValuePair("owner_id", "-61889571"));
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View view, ViewGroup parent) {
            ...
            View row = inflater.inflate(R.layout.one_post_priznavashki, parent, false);
