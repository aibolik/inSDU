...
public class SDUpublic extends ActionBarActivity {
    ...
    class PostsRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SDUpublic.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            params.add(new BasicNameValuePair("owner_id", "-23192814"));
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View view, ViewGroup parent) {
            ...
            View row = inflater.inflate(R.layout.one_post_sdupublic, parent, false);
